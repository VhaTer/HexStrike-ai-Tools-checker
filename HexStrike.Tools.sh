...
echo "   • User Manual: https://github.com/0x4m4/hexstrike-ai/blob/master/USER_GUIDE.md"
echo ""
...
echo "   • Blog & Tutorials: https://blog.hexstrike.com"
echo ""
echo -e "${BLUE}🤝 Community & Support:${NC}"
echo "   • Discord Server: https://discord.gg/hexstrike"
echo "   • Reddit Community: https://reddit.com/r/hexstrike"
echo "   • Twitter: @HexStrikeAI"
echo "   • YouTube Channel: HexStrike AI Security"
echo ""
echo -e "${BLUE}📚 Learning Resources:${NC}"
echo "   • Video Tutorials: https://youtube.com/hexstrike"
echo "   • Webinar Series: https://webinars.hexstrike.com"
echo "   • Training Courses: https://training.hexstrike.com"
echo "   • Certification Program: https://certs.hexstrike.com"
echo ""
echo -e "${BLUE}🔬 Research & Development:${NC}"
echo "   • Research Papers: https://research.hexstrike.com"
echo "   • CVE Database: https://cve.hexstrike.com"
echo "   • Exploit Database: https://exploits.hexstrike.com"
echo "   • Bug Bounty Program: https://bounty.hexstrike.com"
echo ""
